...
class EdgeVertexOperator:
    ...
    def __sub__(self, other: EdgeVertexOperator) -> EdgeVertexOperator: ...
    def __isub__(self, other: EdgeVertexOperator) -> None: ...
    def __mul__(self, other: builtins.complex) -> EdgeVertexOperator: ...
    def __rmul__(self, other: builtins.complex) -> EdgeVertexOperator: ...
    def __imul__(self, other: builtins.complex) -> None: ...
    def __truediv__(self, other: builtins.complex) -> EdgeVertexOperator: ...
    def __itruediv__(self, other: builtins.complex) -> None: ...
    def __neg__(self) -> EdgeVertexOperator: ...
    def __and__(self, other: EdgeVertexOperator) -> EdgeVertexOperator: ...
    def __iand__(self, other: EdgeVertexOperator) -> None: ...
    def __matmul__(self, other: EdgeVertexOperator) -> EdgeVertexOperator: ...
    def __imatmul__(self, other: EdgeVertexOperator) -> None: ...
    def __len__(self) -> builtins.int: ...
    def __deepcopy__(self, _memo: typing.Any) -> EdgeVertexOperator: ...
    def __pow__(self, exponent: builtins.int, modulo: typing.Optional[builtins.int] = None) -> EdgeVertexOperator: ...
    def __str__(self) -> builtins.str: ...
    def __new__(cls, coeffs: typing.Sequence[builtins.complex], left_indices: typing.Sequence[builtins.int], right_indices: typing.Sequence[builtins.int], boundaries: typing.Sequence[builtins.int]) -> EdgeVertexOperator: ...
    @classmethod
    def from_dict(cls, data: typing.Mapping[typing.Sequence[tuple[builtins.int, builtins.int]], builtins.complex]) -> EdgeVertexOperator:
        r"""
    ...
    def get_support(self) -> builtins.set[builtins.int]:
        ...
        """
    def __richcmp__(self, other: EdgeVertexOperator, op: int) -> builtins.bool: ...
    def __repr__(self) -> builtins.str: ...
    def __format__(self, _format_spec: builtins.str) -> builtins.str: ...
    @classmethod
    def zero(cls) -> EdgeVertexOperator:
        r"""
        ...
        """
    @classmethod
    def one(cls) -> EdgeVertexOperator:
        r"""
        ...
        ..
        """
    def simplify(self, atol: builtins.float = 1e-08) -> EdgeVertexOperator:
        r"""
    ...
    def ichop(self, atol: builtins.float = 1e-08) -> None:
        ...
        Args:
            atol: the absolute tolerance for the cutoff. This value defaults to ``1e-8``.
        """
    def iter_terms(self) -> EdgeVertexOperatorDataIter:
        r"""
        ...
        """
    @classmethod
    def from_terms(cls, terms: typing.Any) -> EdgeVertexOperator:
        r"""
        ...
        Returns:
            A new operator.
        """
    def iter_terms_with_groups(self) -> EdgeVertexOperatorDataGroupIter:
        r"""
        ...
        """
    @classmethod
    def from_terms_with_groups(cls, terms: typing.Any) -> EdgeVertexOperator:
        r"""
    ...
    def adjoint(self) -> EdgeVertexOperator:
        ...
        ..
        """
    def equiv(self, other: EdgeVertexOperator, atol: builtins.float = 1e-08) -> builtins.bool:
        r"""
    ...
    def is_hermitian(self, atol: builtins.float = 1e-08) -> builtins.bool:
        ...
        """
    def relabel_modes(self, permutation: typing.Sequence[builtins.int]) -> EdgeVertexOperator:
        r"""
    ...
    @staticmethod
    def _anti_commutator_(op_a: EdgeVertexOperator, op_b: EdgeVertexOperator) -> EdgeVertexOperator: ...
    @staticmethod
    def _double_commutator_(op_a: EdgeVertexOperator, op_b: EdgeVertexOperator, op_c: EdgeVertexOperator, sign: builtins.bool) -> EdgeVertexOperator: ...

@typing.final
class EdgeVertexOperatorDataGroupIter:
    def __iter__(self) -> EdgeVertexOperatorDataGroupIter: ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[tuple[builtins.int, builtins.int]], builtins.complex, builtins.int]]: ...

@typing.final
class EdgeVertexOperatorDataIter:
    def __iter__(self) -> EdgeVertexOperatorDataIter: ...
