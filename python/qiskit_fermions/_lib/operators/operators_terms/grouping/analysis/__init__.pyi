...
def group_coeff_means(op: OperatorTrait) -> typing.Optional[builtins.list[builtins.float]]:
    r"""
...
def groups_are_hermitian(op: OperatorTrait, *, atol: builtins.float = 1e-08) -> typing.Optional[builtins.list[builtins.bool]]:
    r"""
...
def groups_have_uniform_coeffs(op: OperatorTrait, *, atol: builtins.float = 1e-08, abs: builtins.bool = True) -> typing.Optional[builtins.list[builtins.bool]]:
    r"""
