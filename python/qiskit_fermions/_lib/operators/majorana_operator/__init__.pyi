...
class MajoranaOperatorDataGroupIter:
    ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[builtins.int], builtins.complex, builtins.int]]: ...

@typing.final
class MajoranaOperatorDataIter:
    def __iter__(self) -> MajoranaOperatorDataIter: ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[builtins.int], builtins.complex]]: ...
