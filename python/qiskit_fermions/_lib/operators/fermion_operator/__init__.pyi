...
class FermionOperatorDataGroupIter:
    ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[tuple[builtins.bool, builtins.int]], builtins.complex, builtins.int]]: ...

@typing.final
class FermionOperatorDataIter:
    def __iter__(self) -> FermionOperatorDataIter: ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[tuple[builtins.bool, builtins.int]], builtins.complex]]: ...
