...
class TransferVertexOperatorDataGroupIter:
    ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[tuple[builtins.int, builtins.int]], builtins.complex, builtins.int]]: ...

@typing.final
class TransferVertexOperatorDataIter:
    def __iter__(self) -> TransferVertexOperatorDataIter: ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[tuple[builtins.int, builtins.int]], builtins.complex]]: ...
