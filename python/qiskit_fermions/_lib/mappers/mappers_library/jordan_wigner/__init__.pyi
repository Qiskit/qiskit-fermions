...
def edge_vertex_jordan_wigner(op: edge_vertex_operator.EdgeVertexOperator, num_qubits: builtins.int) -> qiskit.quantum_info.SparseObservable:
    r"""
...
def majorana_jordan_wigner(op: majorana_operator.MajoranaOperator, num_qubits: builtins.int) -> qiskit.quantum_info.SparseObservable:
    r"""
...
def transfer_vertex_jordan_wigner(op: transfer_vertex_operator.TransferVertexOperator, num_qubits: builtins.int) -> qiskit.quantum_info.SparseObservable:
    r"""
