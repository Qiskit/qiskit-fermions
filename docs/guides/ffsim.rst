...
Simulation itself, however, *is* ffsim's concern. :class:`ffsim.SupportsLinearOperator` and
:class:`ffsim.SupportsTrace` are implemented by converting this package's :class:`.FermionOperator` into
